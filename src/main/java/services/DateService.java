...
public class DateService {
    ...
    /**
     * Using {@link DateService#DATE_PATTERN} to format date to string.
     * @param date - date
    ...
    /**
     * Converting string using {@link DateService#DATE_PATTERN} into {@link LocalDate}.
    ...
    public static boolean validDate(String dateString) {
        return DateService.parse(dateString) != null;
    }
