...
public class WebDriverService {
    ...
    public static HashSet<Book> findBooksGoogle(String title, String author) throws BooksNotFoundException, DriverWasClosedException {
        try {
            ...
            new Select(driver.findElement(By.name("num"))).selectByIndex(1);
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    for (WebElement we : list) {
                        result.add(new Review(we.findElement(By.className("eComment_Text_Text")).getText(), we.findElement(By.className("eComment_Info_Username_Link")).getText(), "ozon.ru", DateService.parseOzon(we.findElement(By.className("eComment_Info_Date")).getText()), getMarkFromWEOzon(we)));
                    }
                } catch (NoSuchElementException e) {
                    return result;
            ...
            try {
                ...
                try {
                    ...
                    for (int i = 0; i < listMark.size(); i++) {
                        result.add(new Review(listText.get(i).getText(), listAuthor.get(i).getText(), "labirint.ru", DateService.parseLabirint(listDate.get(i).getText()), getMarkFromWELabirint(listMark.get(i))));
                    }
